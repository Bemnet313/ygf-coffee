...
export const translations: Record<string, { en: string; am: string }> = {
    ...
    PRODUCTS_SUBTITLE: { en: 'Showcasing our premium Grade 1 lots. We source and export all grades (1–4), washed and natural, from Ethiopia\'s most celebrated regions.', am: 'ልዩ የሆኑ የደረጃ ፩ ምርቶቻችንን እዚህ ያገኛሉ። የታጠበ እና በተፈጥሮ የደረቀ ከደረጃ ፩ እስከ ፬ ያሉ ሁሉንም የቡና አይነቶች ከኢትዮጵያ ምርጥ የቡና ክልሎች እናቀርባለን።' },
    ...
    SUSTAINABILITY_S2_DESC: { en: 'Every lot is tracked from farm to export for full transparency, every step.', am: 'ከመትከል እስከ ኤክስፖርት ያለውን ሂደት ሙሉ በሙሉ መከታተል የሚያስችል አሰራር።' },
    ...
    TESTIMONIAL_Q2: { en: 'The transparency and traceability they offer is unmatched. And the cup profile is vibrant, floral, and deeply complex, which speaks for itself.', am: 'የሚያቀርቡት ግልጽነት እና ተከታታይነት አቻ የለውም። የቡናው ጣዕም ልዩ እና ጥልቅ ውስብስብነት ያለው ሲሆን ስለ ራሱ ይናገራል።' },
    ...
    ABOUT_P1: { en: 'YGF is a family-run Ethiopian coffee export business based in <strong className="font-bold text-[#1B4332]">Addis Ababa</strong>. We are built on three generations of care, taking our name from our founders: <strong className="font-bold text-[#1B4332]">Yishak, Yacob, Yoseph, Girum, and Faith</strong>.', am: 'ዋይጂኤፍ በአዲስ አበባ የሚገኝ የሶስት ትውልድ ዕውቀትና ጥንቃቄ ላይ የተመሰረተ የኢትዮጵያ ቡና ኤክስፖርት ቤተሰባዊ ድርጅት ነው። ስሙ ከቤተሰብ መስራቾች ስም የተገኘ ነው, እነሱም <strong className="font-bold text-[#1B4332]">ይስሃቅ፣ ያዕቆብ፣ ዮሴፍ፣ ግሩም እና ፌይዝ</strong>።' },
    ABOUT_P2: { en: 'We export the best <strong className="font-bold text-[#1B4332]">green coffee</strong> from Ethiopia\'s top regions to roasters worldwide. Our coffee is carefully chosen and <strong className="font-bold text-[#1B4332]">easy to trace</strong>. We focus on building strong, simple partnerships with people who want great coffee direct from the source.', am: 'ከምርጥ የኢትዮጵያ የቡና ክልሎች የተመረጠ አረንጓዴ ቡና ለዓለም እናቀርባለን። እያንዳንዱ ምርት በጥንቃቄ የተመረጠ እና ምንጩ የሚታወቅ ነው። ጥራት ያለው ቡና በቀጥታ ከምንጩ ለሚፈልጉ ደንበኞቻችን ዘላቂ ትብብር ለመፍጠር እንሰራለን።' },
    ...
    GALLERY_ITEM2_DESC: { en: 'Every cherry is hand-picked at the right moment and sorted by experienced farmers, ensuring only the best makes the cut.', am: 'እያንዳንዱ የቡና ፍሬ በትክክለኛው ጊዜ በእጅ ይመረጣል።' },
    ...
    GALLERY_ITEM4_DESC: { en: 'Our experts cup and test every lot for aroma, body, and flavor to guarantee nothing ships unless it\'s perfect.', am: 'ባለሙያዎች የቡናውን ጥራት ደረጃ በደረጃ ያረጋግጣሉ።' },
